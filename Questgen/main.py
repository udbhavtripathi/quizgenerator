...
class QGen:
    ...
    def predict_mcq(self, payload,num_options):
        start = time.time()
        inp = {
        ...
        print("number of keyword:", len(keywords))
        ...
        if len(keyword_sentence_mapping.keys()) == 0:
            ...
            try:
                generated_questions = generate_questions_mcq(keyword_sentence_mapping,self.device,self.tokenizer,self.model,self.s2v,self.normalized_levenshtein,num_options)
